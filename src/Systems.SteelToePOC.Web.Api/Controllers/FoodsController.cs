...
namespace Systems.SteelToePOC.Web.Api.Controllers
{
    ...
    public class FoodsController : ControllerBase
    {
        ...
        private IEnumerable<LinkDto> GetLinks(int id)
        {
            var links = new List<LinkDto>
            {
                new LinkDto(_urlHelper.Link(nameof(GetSingleFood), new { id }),
              "self",
              "GET"),

                new LinkDto(_urlHelper.Link(nameof(RemoveFood), new { id }),
              "delete_food",
              "DELETE"),
              ...
              "POST"),
                ...
                new LinkDto(_urlHelper.Link(nameof(UpdateFood), new { id }),
               "update_food",
               "PUT")
            };
